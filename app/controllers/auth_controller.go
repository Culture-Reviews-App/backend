...
import (
	...
	"github.com/Culture-Reviews-App/backend/platform/cache"
...
// @Accept json
// @Produce json
// @Param user body models.SignUp true "User Sign Up Information"
...
func UserSignUp(c *fiber.Ctx) error {
	...
	db, err := database.OpenDBConnection("users")
	if err != nil {
...
// @Accept json
// @Produce json
// @Param user body models.SignIn true "User Sign Up Information"
